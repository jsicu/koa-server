 ...
 * @LastEditors: linzq
 * @LastEditTime: 2021-03-23 22:20:41
...
// users
const scenicSpot = seq.define('scenic_spot', {
  destId: {
  ...
  grade_2015: { type: Sequelize.INTEGER, comment: '年度景区等级，数字几代表几级' },
  grade_2016: { type: Sequelize.INTEGER, comment: '年度景区等级' },
  grade_2017: { type: Sequelize.INTEGER, comment: '年度景区等级' },
  grade_2018: { type: Sequelize.INTEGER, comment: '年度景区等级' },
  grade_2019: { type: Sequelize.INTEGER, comment: '年度景区等级' },
  grade_2020: { type: Sequelize.INTEGER, comment: '年度景区等级' },
  type: {
    type: Sequelize.INTEGER,
    comment:
